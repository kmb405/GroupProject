...
<body>
	...
	<div class="container">
		...
		<div class="container"
			...
			<h4>
				METHOD: <span class="items">${pizza.getDeliveryMethod()}</span>
			</h4>
			<h4>
				QTY: <span class="items">${pizza.getQuantity()}</span>
			</h4>
			<h4>
				SIZE: <span class="items">${pizza.getSize()}</span>
			</h4>
			<h4>
				CRUST: <span class="items">${pizza.getCrust()}</span>
			</h4>
			<h4>
				TOPPINGS: <span class="items">${tempToppings}</span>
			</h4>
			...
			<div class="container buttons">
				<div class="row justify-content-around">
					<div class="col-4 mb-3 ms-4 mt-3">
						<a href="/deletePizza/${pizza.getId()}" class="btn btn-danger btn-md btn-block"
							style= "box-shadow: 8px 8px black">START
							OVER</a>
					</div>
					<div class="col-4 ms-4 mt-3">
						<a href="/account/${pizza.getUser().getId()}"
							class="btn btn-success btn-md btn-block"
							style= "box-shadow: 8px 8px black">PLACE ORDER</a>
					</div>
