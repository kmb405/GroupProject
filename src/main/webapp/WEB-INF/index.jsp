...
body {
    ...
    .card-body {
         background-color: rgba(0, 0, 0, 0.5); /* Set a semi-transparent background color for the card body */
		...
		<div class="container-fluid">
			<div class="d-flex justify-content-between w-100">
				<a class="navbar-brand" href="/"> <img
					src="/images/crusty2.PNG" alt="CrustyMascot" width="130"
  ...
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Our Classic Cheese Pizza. Subtly flavored with fresh Basil leaves. </p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Our Special Buffalo sauce with just the right blend of cheeses.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Mushrooms with a perfect Sprinkling of Roasted Garlic.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/slice_plainasspep.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Pepperoni Pizza</h5>
        <p class="card-text">One of our Favorites with the perfect amount of Pepperoni sprinkled with Parmesan Cheese. </p>
      </div>
    </div>
  </div>
</div>
