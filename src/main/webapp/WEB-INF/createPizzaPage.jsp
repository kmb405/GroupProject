...
<body>
		...
		<div class="container-fluid">
			<div class="d-flex justify-content-between w-100">
				...
				<ul class="navbar-nav mt-4">
					<li class="nav-item"><a class="m-2 nav-link btn fs-5" href="/quickPage">Home</a></li>
					<!-- Needs to show how many items are in order on any page -->
					<li class="nav-item"><a class="m-2 nav-link btn fs-5" href="/orderSum/${userId}">Order</a></li>
					
					<li class="nav-item"><a class="m-2 nav-link btn fs-5" href="/account/${userId}">Account</a></li>
	...
	<div class="container" style="width: 35%; margin-top: 10%">
		...
		<div class="container"
			style="border: solid black 8px; width: 100%; border-radius: 15px; padding: 20px;">
			...
			<form:form action="/newPizza" method="POST" modelAttribute="newPizza">
				...
				<div class="container" id="topFormTwo"
					...
					<form:input type="number" min="1" max="100" path="quantity"
						value="1" style="border: black solid 2px;"></form:input>
				...
				<label style="margin-left: 10px; margin-top: 10px;">
					TOPPINGS:</label>
				<form:errors path="toppings" class="text-danger"></form:errors>

				<div class="container"
					style="border: solid black 5px; height: 150px; width: 80%; flex-wrap: wrap; flex-direction: column; overflow-y: auto; align-content: flex-start; column-count: 4; margin-left: 15%; padding: 10px; border-radius: 5px;">
					...
					<div class="container" id="toppingsBoxes">
						...
						<c:forEach var="top" items="${pizzaTops}">
							...
							<input type="checkbox" name="toppings" value="${top}"
								path="toppings">
							<label for="toppings" path="toppings"> <c:out
									value="${top}"></c:out></label>
							<br>
				...
				<button class="btn btn-danger"
					style="width: 100%; margin-top: 10px; border: black inset 5px; box-shadow: 8px 8px black">ADD
					TO ORDER</button>
